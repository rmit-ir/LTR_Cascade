...
bigramhash_t *load_bigrammap(const char *fname) {
  ...
  while (
      fscanf(
          input, "%s %s %" SCNu64 " %" SCNu64
                 " %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf "
                 "%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf "
                 "%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf "
                 "%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf "
                 "%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n",
          term_a, term_b, &cf, &cdf, &geo_mean, &bm25_median_score,
          &bm25_firstq_score, &bm25_thirdq_score, &bm25_max_score,
          &bm25_min_score, &bm25_mean_score, &bm25_score_variance,
          &bm25_score_stddev, &bm25_score_confidence, &bm25_score_harmonic_mean,
          &tf_median_score, &tf_firstq_score, &tf_thirdq_score, &tf_max_score,
          &tf_min_score, &tf_mean_score, &tf_score_variance, &tf_score_stddev,
          ...
          &dfr_score_confidence, &dfr_score_harmonic_mean) == 75) {
...
char *fgen_bigram_qry_main(bigramhash_t *bigrammap, int qnum, char **termv,
                           size_t termc) {
  int tcnt = 0, i = 0;
