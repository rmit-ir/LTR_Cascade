...
class FUtils {
   ...
   public:
     ...
     */
    static std::vector<std::vector<std::string>> get_tokens(std::string fname, std::string delim) {
   ...
   private:
     ...
     * @return query tokens
     */
    static std::vector<std::string> get_qres_tuple(std::string qstr, std::string delim) {
