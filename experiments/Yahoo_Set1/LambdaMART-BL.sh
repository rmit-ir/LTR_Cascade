...
learning_rate=0.05
subsample=0.8
tag="LambdaMART.learning_rate=$learning_rate,subsample=$subsample"

python $ROOT/python/GBDT.py train_LambdaMART \
...
python $ROOT/python/GBDT.py predict_LambdaMART \
